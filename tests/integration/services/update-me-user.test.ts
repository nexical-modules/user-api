...
import { UpdateMeUserAction } from '@/actions/update-me-user';
import type { UpdateUserDTO } from '@/sdk/types';
describe('UpdateMeUserAction - Service Integration', () => {
  it('should execute successfully', async () => {
    ...
    const input: UpdateUserDTO = {} as UpdateUserDTO; // TODO: Provide valid mock data
