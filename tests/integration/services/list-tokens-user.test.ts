...
import { ListTokensUserAction } from '@/actions/list-tokens-user';
import type { ListTokensDTO } from '@/sdk/types';
describe('ListTokensUserAction - Service Integration', () => {
  it('should execute successfully', async () => {
    ...
    const input: ListTokensDTO = {} as ListTokensDTO; // TODO: Provide valid mock data
