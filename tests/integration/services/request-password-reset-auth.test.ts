...
import { RequestPasswordResetAuthAction } from '@/actions/request-password-reset-auth';
...
describe('RequestPasswordResetAuthAction - Service Integration', () => {
  it('should execute successfully', async () => {
    ...
    const input: RequestPasswordResetDTO = {} as RequestPasswordResetDTO; // TODO: Provide valid mock data
