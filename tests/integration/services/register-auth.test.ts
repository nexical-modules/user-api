...
import { RegisterAuthAction } from '@/actions/register-auth';
import type { CreateUserDTO } from '@/sdk/types';
describe('RegisterAuthAction - Service Integration', () => {
  it('should execute successfully', async () => {
    ...
    const input: CreateUserDTO = {} as CreateUserDTO; // TODO: Provide valid mock data
