...
import { POST } from '../../../../../../src/pages/api/auth/password/request-reset';
vi.mock('../../../../../../src/actions/request-password-reset-auth');
vi.mock('@/lib/api/api-guard');

describe('Auth API - POST ../../../../../../src/pages/api/auth/password/request-reset', () => {
  beforeEach(() => {
    vi.resetAllMocks();
